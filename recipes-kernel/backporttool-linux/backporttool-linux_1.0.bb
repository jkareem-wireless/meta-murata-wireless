...
SRC_URI =  " \
    git://github.com/jkareem-murata/cyw-fmac;protocol=http;branch=imx-rocko-mini-zigra \
"
...
DEPENDS += "virtual/kernel bison-native flex-native bash"
inherit module-base


do_configure_prepend() {
	ln -sf /usr/bin/seq ${HOSTTOOLS_DIR}/seq
	echo "ENVIRONMENT - BEGINNING"
#	env
